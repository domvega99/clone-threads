...
const Activity = () => {
  return (
    <div className='relative bg-black md:flex md:justify-center'>
        <div className='bg-black pt-5 pl-5 text-white min-h-screen md:w-2/4'>
            ...
            <div className=' flex overflow-x-auto hide-scroll-bar my-5 font-semibold'>
                ...
                <button className=' flex-shrink-0 mr-2 py-1 border border-neutral-500 rounded-lg w-32 disabled:bg-gray-200' disabled>Replies</button>
                <button className=' flex-shrink-0 mr-2 py-1 border border-neutral-500 rounded-lg w-32 disabled:bg-gray-200' disabled>Mentions</button>
                <button className=' flex-shrink-0 mr-5 py-1 border border-neutral-500 rounded-lg w-32 disabled:bg-gray-200' disabled>Verified</button>
            </div>
